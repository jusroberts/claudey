...
#
#     PHX_SERVER=true bin/wigglebot_server start
#
...
if config_env() == :prod do
  ...
  config :wigglebot_server, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :wigglebot_server, WigglebotServer.Mailer,
